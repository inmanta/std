...
sudo -u centos -- /home/centos/venv/bin/python3 -m pip install -r https://raw.githubusercontent.com/inmanta/std/${GIT_LOCAL_BRANCH}/requirements.txt
sudo -u centos -- /home/centos/venv/bin/python3 -m pip install -r https://raw.githubusercontent.com/inmanta/std/${GIT_LOCAL_BRANCH}/requirements.dev.txt
